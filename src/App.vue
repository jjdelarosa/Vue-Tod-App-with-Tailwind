<template>
  <div class="h-screen w-widht bg-red-600 flex flex-col justify-center items-center">
    <div class="header">
      <h1 class="text-4xl">🚀 My To do List With Tailwind and Vue 🚀</h1>
      <div class="form flex">
        <input
          v-model="newTodo"
          @keyup="checkAdd"
        ...
        <button
          id="newBtn"
          @click="add"
          class="bg-purple-500 hover:bg-green-500 text-white font-bold py-2 px-4"
        >Add</button>
      </div>
    </div>
